...
/* BackClinicalSituationBundle:Form:add.html.twig */
class __TwigTemplate_d4460e61a55731d34994f2997d686b3815d0ba099e1dad5e0af34eba1b25bd73 extends Twig_Template
{
...
\t";
        ...
        echo "\t
\t<section id=\"admin\">
\t\t<h1>Ajout d'une situation clinique</h1>
...
\t\t\t<form method=\"post\" action=\"";
        // line 15
        echo $this->env->getExtension('routing')->getPath("back_CS_add");
        echo "\" ";
...
\t\t\t\t\t<td>";
        // line 23
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "parent"), 'widget');
        echo "</td>
\t\t\t\t</tr>
\t\t\t\t<tr>
\t\t\t\t\t<th>";
...
";
    ...
    {
        return "BackClinicalSituationBundle:Form:add.html.twig";
    }
