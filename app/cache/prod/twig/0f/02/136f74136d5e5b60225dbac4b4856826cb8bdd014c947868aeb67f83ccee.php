...
/* BackPartnerBundle::index.html.twig */
class __TwigTemplate_0f02136f74136d5e5b60225dbac4b4856826cb8bdd014c947868aeb67f83ccee extends Twig_Template
{
...
\t\t\t\t\t\t\t<a href=\"";
            // line 29
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("back_partner_update", array("id" => $this->getAttribute((isset($context["item"]) ? $context["item"] : null), "id"))), "html", null, true);
            echo "\"><img src=\"";
...
\t\t\t\t\t\t\t<a data-ref=\"";
            // line 30
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("back_partner_delete", array("id" => $this->getAttribute((isset($context["item"]) ? $context["item"] : null), "id"))), "html", null, true);
...
";
    ...
    {
        return "BackPartnerBundle::index.html.twig";
    }
