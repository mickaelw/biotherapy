...
\t\t\t\t\t<th>";
        // line 22
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "url"), 'label', array("label" => "Site internet"));
        echo "</th>
\t\t\t\t\t<td>";
        // line 23
...
\t\t\t\t\t<th>";
        // line 26
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "media"), 'label', array("label" => "Logo"));
        echo "</th>
\t\t\t\t\t<td>";
        // line 27
