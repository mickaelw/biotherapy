 ...
 */
class Partner extends \Front\WebsiteBundle\Entity\Partner implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Front\\WebsiteBundle\\Entity\\Partner' . "\0" . 'id', '' . "\0" . 'Front\\WebsiteBundle\\Entity\\Partner' . "\0" . 'name', '' . "\0" . 'Front\\WebsiteBundle\\Entity\\Partner' . "\0" . 'url', '' . "\0" . 'Front\\WebsiteBundle\\Entity\\Partner' . "\0" . 'media');
        }
