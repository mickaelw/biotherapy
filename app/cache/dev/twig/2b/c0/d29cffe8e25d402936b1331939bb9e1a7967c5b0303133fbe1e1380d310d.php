...
/* BackClinicalSituationBundle::index.html.twig */
class __TwigTemplate_2bc0d29cffe8e25d402936b1331939bb9e1a7967c5b0303133fbe1e1380d310d extends Twig_Template
{
...
\t";
        ...
        echo "\t
\t<section id=\"admin\">
\t\t<h1>Gestion des situations cliniques</h1>
...
\t\t\t\t\t\t<td>";
            // line 29
            echo twig_escape_filter($this->env, (($this->getAttribute($this->getAttribute((isset($context["item"]) ? $context["item"] : null), "parent", array(), "any", false, true), "name", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute((isset($context["item"]) ? $context["item"] : null), "parent", array(), "any", false, true), "name"), " ")) : (" ")), "html", null, true);
            echo "</td>
\t\t\t\t\t\t<td>
\t\t\t\t\t\t\t<a href=\"";
            // line 31
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("back_CS_update", array("id" => $this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "id"))), "html", null, true);
            echo "\"><img src=\"";
...
\t\t\t\t\t\t\t<a data-ref=\"";
            // line 32
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("back_CS_delete", array("id" => $this->getAttribute((isset($context["item"]) ? $context["item"] : $this->getContext($context, "item")), "id"))), "html", null, true);
...
";
    ...
    {
        return "BackClinicalSituationBundle::index.html.twig";
    }
