...
/* BackPartnerBundle:Form:add.html.twig */
class __TwigTemplate_07231e2672fc57fca463807adb86e16bb60fce6c93d67db44337432f43c96b42 extends Twig_Template
{
...
\t\t\t\t\t<th>";
        // line 22
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "url"), 'label', array("label" => "Site internet"));
        echo "</th>
\t\t\t\t\t<td>";
        // line 23
...
\t\t\t\t\t<th>";
        // line 26
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "media"), 'label', array("label" => "Logo"));
        echo "</th>
\t\t\t\t\t<td>";
        // line 27
...
";
    ...
    {
        return "BackPartnerBundle:Form:add.html.twig";
    }
