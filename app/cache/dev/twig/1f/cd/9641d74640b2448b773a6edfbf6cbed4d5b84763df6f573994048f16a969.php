...
/* BackCardBundle:Form:update.html.twig */
class __TwigTemplate_1fcd9641d74640b2448b773a6edfbf6cbed4d5b84763df6f573994048f16a969 extends Twig_Template
{
...
\t\t\t<form method=\"post\" action=\"";
        // line 15
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("back_card_update", array("id" => $this->getAttribute((isset($context["obj"]) ? $context["obj"] : $this->getContext($context, "obj")), "id"))), "html", null, true);
        echo "\" ";
...
";
    ...
    {
        return "BackCardBundle:Form:update.html.twig";
    }
